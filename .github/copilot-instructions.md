...
- Favor the creation of small (<150 lines) files that are focused on a single purpose. Organize these files into subdirectories based on related functions or domains.
