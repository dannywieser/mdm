...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "calendar.dayDetailTitle": "{date}",
    "calendar.entryLabel": "{description} ({status})",
    "calendar.expenseCount": "{count} out",
    "calendar.expenses": "out",
    "calendar.income": "in",
    "calendar.incomeCount": "{count} in",
    "calendar.net": "net",
    "calendar.nextMonth": "next month",
    "calendar.previousMonth": "previous month",
    "calendar.status.logged": "logged",
    "calendar.status.scheduled": "scheduled",
    "calendar.thisMonth": "today",
    ...
    "gallery.closeFilters": "close filters",
    "gallery.filters": "filters",
    "gallery.removeFilter": "remove filter: {label}",
    "gallery.year": "year",
    "errors.unableToLoadReadState": "unable to load read state",
    "errors.unableToLoadStats": "unable to load stats",
    "errors.unableToLoadTransactions": "unable to load transactions",
    ...
    "stats.activityCreated": "{created} created",
    "stats.activityFoldersTouched": "{folders} folders touched",
    "stats.activityGraph": "activity",
    "stats.activityModified": "{modified} modified",
