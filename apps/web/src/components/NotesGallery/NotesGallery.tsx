...
export const NotesGallery = ({ badges = [], notesGalleryFilters = [] }: NotesGalleryProps) => {
  const { t } = useI18n()
  ...
  const frontmatterFacets = useMemo(
    () => buildFrontmatterFacets(notesWithImages, notesGalleryFilters),
    [notesWithImages, notesGalleryFilters],
  )
