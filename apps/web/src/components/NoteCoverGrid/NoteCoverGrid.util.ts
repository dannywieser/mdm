...
import type { MasonryLayout } from "./NoteCoverGrid.types"
...
const MASONRY_LAYOUT: MasonryLayout = {
...
/** Grid metrics for the gallery, shared by the grid and its cards. */
export function getMasonryLayout(): MasonryLayout {
